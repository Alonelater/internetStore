    ...
    <c:if test="${not empty cart.cartItems}">
        ...
        <div style="margin-right:130px;">
            ...
            <div style="text-align:right;margin-top:10px;margin-bottom:10px;">
                <a href="${pageContext.request.contextPath}/cartServlet?method=clearCart cxvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv" id="clear" class="clear">清空购物车</a>
